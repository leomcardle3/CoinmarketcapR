...
top_movers_df <- data.frame(top_movers$name, top_movers$symbol, top_movers$cmc_rank, top_movers$USD_price, 
                            top_movers$USD_percent_change_24h, top_movers$USD_percent_change_7d)
